    ...
    return (
      <div>
        <Row>
          ...
          <Col sm={4}>
            <Breadcrumb>
              ...
              <Breadcrumb.Item active>HR Companies</Breadcrumb.Item>
            </Breadcrumb>
          </Col>
        </Row>
        ...
        <Card border="info">
          <Card.Header>
            <Row>
              <Col sm={8}>HR Companies Table</Col>
              <Col sm={4}>
                {/* <div align="right">
                    ...
                    <div className="card mb-2 h-100">
                      ...
                      <div className="card-body position-relative">
                        <div className="img-profile position-absolute top-0 start-50 translate-middle">
                          {rs.user_main_company.length > 0 && (
                            <div>
                              {(rs.user_main_company[0].uc_company_cover !==
                                "" ||
                                rs.user_main_company[0].uc_company_cover !==
                                  null) && (
                                <Image
                        ...
                        <div className="row mt-5">
                          <div className="col text-center">
                            <LinkContainer to={`/candidate/${rs.user_id}`}>
                              <Button variant="outline-primary">
                                <h4>
                                  {rs.user_main_company.length > 0 && (
                                    <span>
                                      {rs.user_main_company[0].uc_company_name}
                                    </span>
                                  )}
                                </h4>
                              </Button>
                            ...
                            <div>
                              <span>
                                Contact person : {rs.firstname} {rs.lastname}
                              </span>
                            </div>
                          </div>
                        </div>
